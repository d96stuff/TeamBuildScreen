namespace TeamBuildScreen.Tfs2012.Models
{
	...
	{
		public Tfs2012BuildInfo(IBuildDetail buildDetail, string flavour, string platform, IEnumerable<ITestRun> testRuns, ICoverageAnalysisManager coverageAnalysisManager)
		{
